#ifndef __GAME_SCENE_FLYGUY_H__
#define __GAME_SCENE_FLYGUY_H__
...
class GameScene_FlyGuy : public BaseScene, public b2ContactListener
{
public:
...
private:
    ...
    bool m_bFlying;
    cocos2d::LayerColor * m_pEnemy;
    bool m_bEnemyActive;
    float m_fEnemyActiveTimer;
    cocos2d::Sprite * m_pBouns;
    float m_fBounsTimer;
    cocos2d::CCLabelTTF * m_pBounsText;
    int m_iBounsCount;
    ...
    void addBouns(float y);
    void onGameOver();
    void restartGame(cocos2d::Node * pSender);
    void updateBounsText();
};

#endif // __GAME_SCENE_FLYGUY_H__
